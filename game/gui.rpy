...
define gui.text_font = "Arch_Condensed.ttf"

## Les polices utilisées pour le nom des personnages.
define gui.name_text_font = "Arch_Condensed_Bold.ttf"

## Les polices utilisées pour les textes « hors du jeu ».
define gui.interface_text_font = "Arch_Regular.ttf"

## Les polices utilisées pour les boutons « hors du jeu ».
define gui.bouton_text_font = "Arch_Condensed.ttf"
...
define gui.main_menu_background = Movie(play="images/chambre.webm", loop=True, size=(1920,1080))
...
define gui.button_text_font = gui.bouton_text_font
...
## variables correctement nommées. Par exemple, vous pouvez décommenter la ligne
